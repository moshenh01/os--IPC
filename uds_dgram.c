...
void uds_dgram_sender() {
    ...
    printf("Connected to the server unix_dgram.\n");
    ...
    int chunk_size = 1024*200;  // Set the chunk size to 1024 bytes
    ...
    // while ((bytes_sent = sendto(sockfd, data + bytes_sent_total, DATA_SIZE - bytes_sent_total, 0, (struct sockaddr *)&servaddr, sizeof(servaddr))) > 0){
